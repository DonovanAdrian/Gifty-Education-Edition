...
var friendListEmptyBool = false;        //A global boolean that tells whether the friendList is empty or not
...
var secretSantaSignUp;                  //Stores the secretSantaSignUp button on the webpage
var secretSantaData;                    //Stores the secretSanta data for the appropriate user
var secretSantaNameBool = false;        //Tells whether a secretSantaName has been designated to the user
...
window.onload = function instantiate() {
  ...
  //This function generates the necessary data for the secretSantaModal. It is built to be identical to a user's list modal
